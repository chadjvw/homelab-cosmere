...
#ProviderSpec: {
	...
	// CommitStatusExpr is a CEL expression that evaluates to a string
	// value
	// that can be used to generate a custom commit status message for
	// use
	// with eligible Provider types (github, gitlab, gitea,
	// bitbucketserver,
	// bitbucket, azuredevops). Supported variables are: event,
	// provider,
	// and alert.
	...
	// authenticate with services from cloud providers. An error is
	// thrown if a
	// static credential is also defined inside the Secret referenced
	// by the
	// SecretRef.
