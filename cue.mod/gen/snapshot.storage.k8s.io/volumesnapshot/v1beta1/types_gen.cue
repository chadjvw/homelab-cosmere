...
// point-in-time snapshot of a persistent volume, or binding to a
...
// Required.
#VolumeSnapshotSpec: {
	// source specifies where a snapshot will be created from. This
	// field is immutable after creation. Required.
	source!: {
		// persistentVolumeClaimName specifies the name of the
		// PersistentVolumeClaim object representing the volume from
		// which a snapshot should be created. This PVC is assumed to be
		// in the same namespace as the VolumeSnapshot object. This field
		// should be set if the snapshot does not exists, and needs to be
		// created. This field is immutable.
		persistentVolumeClaimName?: string

		// volumeSnapshotContentName specifies the name of a pre-existing
		// VolumeSnapshotContent object representing an existing volume
		// snapshot. This field should be set if the snapshot already
		// exists and only needs a representation in Kubernetes. This
		// field is immutable.
	...
	// be used. A given cluster may have multiple default Volume
	// SnapshotClasses: one default per CSI Driver. If a
	// VolumeSnapshot does not specify a SnapshotClass,
	// VolumeSnapshotSource will be checked to figure out what the
	// associated CSI Driver is, and the default VolumeSnapshotClass
