...
//timoni:generate timoni mod vendor crd -f ./cilium-1.18.1/pkg/k8s/apis/cilium.io/client/crds/v2/ciliumclusterwidenetworkpolicies.yaml
...
// Spec is the desired Cilium specific rule specification.
#CiliumClusterwideNetworkPolicySpec: matchN(>=1, [{
	ingress!: _
}, {
	ingressDeny!: _
}, {
