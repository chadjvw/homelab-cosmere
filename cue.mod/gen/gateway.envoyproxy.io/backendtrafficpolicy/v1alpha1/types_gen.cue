...
#BackendTrafficPolicySpec: {
	...
	faultInjection?: {
		...
		delay?: {
			...
			fixedDelay!: =~"^([0-9]{1,5}(h|m|s|ms)){1,4}$"
	...
	httpUpgrade?: [...{
		connect?: {
			// Terminate the CONNECT request, and forwards the payload as raw
			// TCP data.
			terminate?: bool
		}
		...
		global?: {
			...
			rules!: list.MaxItems(64) & [...{
				...
				limit!: {
					...
					// Valid RateLimitUnit values are "Second", "Minute", "Hour",
					// "Day", "Month" and "Year".
	...
	requestBuffer?: {
		...
		// "500Ki").
		limit?: matchN(2, [null | bool | number | =~"^(\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))(([KMGTPE]i)|[numkMGTPE]|([eE](\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))))?$" | [...] | {}, null | bool | number | =~"^[1-9]+[0-9]*([EPTGMK]i|[EPTGMk])?$" | [...] | {}]) & matchN(>=1, [int, string])
	}
	...
	responseOverride?: [...{
		match!: {
			...
			statusCodes!: list.MaxItems(50) & [...{
				...
				type!: matchN(2, ["Value" | "Range", "Value" | "Range"])
		...
		response?: {
			...
			// Supports Envoy command operators for dynamic content (see
			...
			body?: {
				...
				type!: matchN(2, ["Inline" | "ValueRef", "Inline" | "ValueRef"])
