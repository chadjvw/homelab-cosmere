...
#EnvoyExtensionPolicySpec: {
	...
	extProc?: list.MaxItems(16) & [...{
		...
		// FailOpen is a switch used to control the behavior when failing
		// to call the external processor.
		//
		// If FailOpen is set to true, the system bypasses the ExtProc
		// extension and
		...
		// an HTTP 5xx error.
		//
		// If set to true, the ExtProc extension will also be bypassed if
	...
	wasm?: list.MaxItems(16) & [...{
		...
		// an HTTP 5xx error.
		//
		// If set to true, the Wasm extension will also be bypassed if the
