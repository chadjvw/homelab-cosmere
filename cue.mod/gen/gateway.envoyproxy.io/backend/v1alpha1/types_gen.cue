...
#BackendSpec: {
	...
	// If TLS is specified here and a BackendTLSPolicy is also
	// configured for the backend, the final TLS settings will
	// be a merge of both configurations. In case of overlapping
	// fields, the values defined in the BackendTLSPolicy will
	// take precedence.
	tls?: {
