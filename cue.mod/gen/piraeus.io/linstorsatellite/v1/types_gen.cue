...
#LinstorSatellite: {
	...
	// LinstorSatelliteSpec defines the desired state of
	// LinstorSatellite
...
#LinstorSatelliteSpec: {
	// ClusterRef references the LinstorCluster used to create this
	// LinstorSatellite.
	clusterRef!: {
		...
		// ClientSecretName references the secret used by the operator to
	...
	// The Controller will use the client key from
	// `LinstorCluster.spec.internalTLS` when connecting.
	internalTLS?: null | {
		// CAReference configures the CA certificate to use when
		// validating TLS certificates.
		// If not set, the TLS secret is expected to contain a "ca.crt"
